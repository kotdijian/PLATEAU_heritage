...
def run_area(area_code: str, data_dir: str | Path, cfg: dict,
    ...
    for city in cities:
        ...
        _write_csv(_city_path(city_dir, city.city_code, "heritage_movable_items.csv"), result["movable_rows"])
        _write_csv(_city_path(city_dir, city.city_code, "heritage_movable_groups.csv"), result["movable_group_rows"])
        ...
        summary = {
            ...
            "movable_groups": len(result["movable_group_rows"]),
            "movable_groups_attached": sum(bool(x.get("linked_building_ids")) for x in result["movable_group_rows"]),
