...
def test_detail_parser_address_detail():
    html = """
    <html><head><meta property="og:title" content="資料A | 文化遺産オンライン"></head>
    <body><dl>
      <dt>所在地</dt><dd>東京都台東区浅草2-3-1</dd>
      <dt>方書</dt><dd>浅草寺境内</dd>
    </dl></body></html>
    """
    r = parse_detail_page("https://bunka.nii.ac.jp/heritages/detail/789", html)
    assert r["address_detail"] == "浅草寺境内"
